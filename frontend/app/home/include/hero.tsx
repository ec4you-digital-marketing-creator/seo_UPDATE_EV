...
export default function HomeHero() {
  return (
    <section className="relative w-full h-screen min-h-[600px] flex items-start bg-[#050505] overflow-hidden">
      ...
      {/* Background Image */}
      <div
        className="absolute inset-0 w-full h-full bg-cover bg-bottom bg-no-repeat opacity-80"
        style={{ backgroundImage: "url('/images/relux-electric-tamilnadu-banner.png')" }}
      />
      {/* ── Hero Content Card — top left ── */}
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-start pt-58 md:pt-56">
